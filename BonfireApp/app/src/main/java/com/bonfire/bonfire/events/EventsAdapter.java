package com.bonfire.bonfire.events;
...
import com.bonfire.bonfire.Database.DatabaseHandler;
import com.bonfire.bonfire.R;
...
public class EventsAdapter extends ArrayAdapter<Event> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if(convertView==null){
            ...
            viewHolder.title = (TextView)convertView.findViewById(R.id.EventName);
            viewHolder.date = (TextView)convertView.findViewById(R.id.EventStart);
            viewHolder.time = (TextView)convertView.findViewById(R.id.EventEnd);
